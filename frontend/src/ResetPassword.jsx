      ...
      <div className="flex justify-center px-4 py-8 sm:py-10">
        ...
        <form onSubmit={handleSubmit} className="text-left space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3 px-3 rounded-xl shadow-md shadow-indigo-600/10 active:scale-[0.99] transition-all cursor-pointer mt-2 disabled:opacity-60"
          >
            {loading ? (
